            ...
            if (this.isListening) {
                if (this.credentials !== undefined) {
                    ...
                    if (!processExists(this.credentials.pid)) {
                        ...
                        setTimeout(() => {
                            this.onTick();
                        }, (_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.pollInterval) !== null && _b !== void 0 ? _b : 2500);
                    }
                }
                else {
                    // Current credentials were invalidated, wait for
                    // client to come back up
                    const credentials = yield authentication_1.authenticate({
                        awaitConnection: true,
                        pollInterval: (_d = (_c = this.options) === null || _c === void 0 ? void 0 : _c.pollInterval) !== null && _d !== void 0 ? _d : 2500
                    });
                    this.credentials = credentials;
